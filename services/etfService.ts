...
const ETF_DATABASE: Record<string, ETFRecord> = {
  ...
  XLE: {
    ...
    holdings: [
      ...
      { symbol: 'BP', name: 'BP plc', weight: 4.5 },
      { symbol: 'SHEL', name: 'Shell plc', weight: 4.2 },
      { symbol: 'EQNR', name: 'Equinor ASA', weight: 3.8 },
      { symbol: 'VAR.OL', name: 'Vår Energi', weight: 2.1 },
  ...
  DBC: {
    ...
    descriptionNo: 'Bred råvarekurv via futures: energi (størst vekt), landbruk, industrimetaller og edelmetaller. Inkluderer også store energi-produsenter som Equinor og Shell for kontekst.',
    descriptionEn: 'Broad commodity basket via futures: energy (largest weight), agriculture, industrial metals and precious metals. Includes major energy producers like Equinor and Shell for context.',
    expenseRatio: 0.85,
    dividendYield: 0.0,
    beta: 0.58,
    peRatio: 0.0,
    holdings: [
      { symbol: 'XOM', name: 'Exxon Mobil', weight: 15.5 },
      { symbol: 'CVX', name: 'Chevron Corp.', weight: 12.3 },
      { symbol: 'SHEL', name: 'Shell plc', weight: 8.5 },
      { symbol: 'BP', name: 'BP plc', weight: 6.2 },
      { symbol: 'EQNR', name: 'Equinor ASA', weight: 5.8 },
      { symbol: 'TTE', name: 'TotalEnergies', weight: 5.2 },
      { symbol: 'COP', name: 'ConocoPhillips', weight: 4.8 },
    ],
