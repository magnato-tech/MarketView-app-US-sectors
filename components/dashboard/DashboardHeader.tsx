...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({ summary }) => {
  ...
  return (
    <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
      ...
      <div className="flex flex-wrap gap-3 overflow-x-auto pb-2 md:pb-0">
         {summary.slice(0, 4).map(s => (
           <div key={s.symbol} className="bg-slate-900 dark:bg-slate-900 light:bg-white border border-slate-800 dark:border-slate-800 light:border-slate-200 p-3 rounded-xl min-w-[130px] transition-all hover:scale-[1.02] shadow-sm shrink-0">
